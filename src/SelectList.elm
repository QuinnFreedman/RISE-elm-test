{-
   Coppied from https://package.elm-lang.org/packages/rtfeldman/selectlist/latest

   This package hasn't moved to elm .19 yet so I just copied the source here for now
-}
